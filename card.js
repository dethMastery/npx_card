    ...
    choices: [
      {
        ...
        value: () => {
          open("mailto:pinyoworapot@suphakit.net");
...
const data = {
  ...
  handle: chalk.white("@dethMastery"),
  work: `${chalk.white("Founder & Artist @")} ${chalk
    .hex("#FF7F50")
    .bold("DeZent")}`,
  twitter: chalk.white("https://twitter.com/") + chalk.cyan("georgeKdeterk"),
...
const me = boxen(
  [
    ...
    ``,
    `${chalk.italic("Hello, world. I'm Suphakit P.")}`,
    `${chalk.italic("I'm a Front-End Developer (with a little of")}`,
    `${chalk.italic("Back-End Skill) & Music Composer. If you want")}`,
    `${chalk.italic("to work with me just feel free to contact me ;)")}`,
  ].join("\n"),
  {
    margin: 1,
    float: "center",
